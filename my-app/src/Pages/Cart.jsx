...
//   // ✅ Update cart both locally & remotely
...
//       {/* 🧺 Cart Items Only (No Order Summary) */}
//       <div className="space-y-6">
//         {cart.map((item, index) => (
//           <div
//             key={`${item.id}-${item.size || index}`}
//             className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all border border-gray-100"
//           >
//             {/* Product Info */}
