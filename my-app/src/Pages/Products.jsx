...
//     localStorage.getItem("sortOrder") || "none"
//   );
...
//           `http://localhost:5000/carts?userId=${storedUser.id}`
//         );
...
function Products() {
  ...
  const handleAddToCart = async (product) => {
    ...
    alert(`✅ ${product.team || product.name} added to cart!`);
  };
